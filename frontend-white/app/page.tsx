...
import { ArrowRight, Briefcase, Users, Building, TrendingUp, Container } from "lucide-react"
...
function ParallaxImages({ children}: ParallaxProps) {
        ...
        useEffect(()=>{
          ...
          let controls;
          let finalPosition = -screenWidth / 2 - 8;
        ...
        <div className="container mx-auto max-w-6xl text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="align-center w-full p-5">
               <div className="container sticky  w-full top-0 p-50 bg-white"> 
                  <section className="w-full text-xl min-width-screen items-center font-semibold bg-white"> We've got you Covered </section> </div>
            <Image
              src="/avatargroup.png"
              alt="avatargroup"
              width={20}
